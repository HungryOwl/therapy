...
class Pathogenesis2016 extends Component {
    ...
    renderLeftColumn() {
        return <div className='hyperglycemia__column flex-align-end'>
    ...
    renderCenterColumn() {
        return <div className='hyperglycemia__column flex-align-center'>
    ...
    renderRightColumn() {
        return <div className='hyperglycemia__column flex-align-start'>
