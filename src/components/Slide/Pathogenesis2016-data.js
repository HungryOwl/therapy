...
export const chainLinks = {
    intestines: {
        ...
        modificators: 'small',
        index: 8,
        arrow: { length: 105, deg: -8, shiftX: 50, shiftY: -5 }
    },
    infection: {
        layout: 'row-reverse',
        align: 'center',
        ...
        img: 'infection',
        modificators: 'small',
        arrow: { length: 140, deg: -30, shiftX: 50, shiftY: 8 }
    },
    stomach: {
        layout: 'row-reverse',
        align: 'center',
        ...
        img: 'stomach',
        index: 10,
        arrow: { length: 65, shiftX: 45, shiftY: 5 }
    },
    symbolB: {
    ...
    incretin: {
        ...
        index: 2,
        tArrow: { length: 40, deg: 90, shiftX: 50, shiftY: -65 }
    },
    cellDefect: {
        layout: 'column-reverse',
        contentLayout: 'column',
        ...
        index: 3,
        tArrow: { length: 10, deg: 90, shiftX: 30, shiftY: 64 }
    },
    kidneys: {
        layout: 'row-reverse',
        align: 'center',
        ...
        modificators: 'small',
        index: 11,
        arrow: { length: 12, deg: 270, shiftX: 40, shiftY: -14 }
    },
    brain: {
        layout: 'row',
        align: 'center',
        ...
        modificators: 'small',
        index: 7,
        arrow: { length: 105, deg: 188, shiftX: 46, shiftY: 3 },
        tArrows: [
